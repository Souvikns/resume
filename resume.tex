...
\begin{document}
    ...
    \section{Summary}
        ...
        \begin{onecolentry}
		Software Developer with 4+ years of experience building backend systems and AI-powered applications. Specialized in RAG architectures, vector databases, and LLM integrations using Go, Node.js, and Python. Experienced in designing scalable, high-performance APIs and developer tools. Maintainer at AsyncAPI and mentor at Google Summer of Code (GSoC).
        \end{onecolentry}
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Designed and implemented a backend system to OCR PDF documents and convert them into RAG-ready knowledge sources, enabling context-aware AI assistant agents.
            \end{highlights}
        \end{onecolentry}
