...
\begin{document}
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{
            ...
            \textbf{GitHub Action that would run generate PR summary using AI.}\end{twocolentry}

        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
            \item Uses AI to generate PR summary with respect of the patch file.
            \item Handles Large context files like package-lock file for nodejs. 
